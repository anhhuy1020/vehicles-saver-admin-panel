    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <card>
                        <b-table thead-class="b-table-thead" thead-tr-class="b-table-thead-tr" :items="feedbacks" :fields="fields" responsive="sm" class="table table-hover table-primary table-light table-sm">
